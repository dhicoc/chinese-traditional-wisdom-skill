...
- 元工具：`agent_guidance`、`validate_bazi_presentation`、`validate_ziwei_presentation`、`validate_bazhai_presentation`、`validate_feixing_presentation`、`validate_calendar_presentation`、`validate_divination_presentation`、`wisdom_dispatch`
...
配置后重启客户端，应能看到 `chinese-wisdom` server 已连接并显示 40 个工具。
