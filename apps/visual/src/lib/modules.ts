...
export const MODULES: WisdomModule[] = [
  ...
  },
  {
    ...
    statusLabel: '多系统聚合',
    privacyLevel: '仅本地计算',
    questionTypes: ['综合运势', '月度运势', '事件决策', '空间布局', '交叉验证', '择吉日'],
    accent: '#9d7ad6',
    description: '跨系统联合分析：年度综合运势（八字+五运六气+奇门+紫微流年/大限+命卦方位）、月度运势（流月干支+五运六气客气步+节气调养+紫微流月）、事件决策（六爻+梅花+奇门三卜交叉验证）、空间+时间（飞星+八宅+奇门吉方）、三式互参（大六壬+奇门+梅花）、三式合一（奇门+太乙+大六壬）、今日养生建议（体质+24节气+子午流注时辰+方位）、综合择日（黄历宜忌+神煞+太岁三煞+命卦吉方筛吉日）。多系统一致性检验。',
  },
  {
    id: 'yunqi',
    group: '医道运气',
